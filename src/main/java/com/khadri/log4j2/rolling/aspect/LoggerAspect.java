package com.khadri.log4j2.rolling.aspect;
...
public class LoggerAspect {
	...
	@Around("@annotation(logFile)")
	public Object logSwiggyUserInOutMessage(ProceedingJoinPoint joinPoint, LogFile logFile) throws Throwable {
		...
		Expression expression = expressionParser.parseExpression(logFile.request());
